...
public class StartCustoProfissionalOLD {

    @XmlElement(name = "dat_refer", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar datRefer;
     ...
     *     
     */
    public XMLGregorianCalendar getDatRefer() {
        return datRefer;
    }
     ...
     *     
     */
    public void setDatRefer(XMLGregorianCalendar value) {
        this.datRefer = value;
    }
